 ...
 */
 ...
 //Your Code Goes Here
 var madlib = "The Intro to JavaScript course is " + adjective + ". James and Julia are so " + adjective2 + ". I cannot wait to work through the rest of this " + adjective3 + ". content!";
 console.log(madlib);
